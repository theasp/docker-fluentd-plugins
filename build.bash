...
JQ=''
ALLOW_FAIL=true
SKIP='^fluent-plugin-(geoblipper|chef-client|grassland|mysql-binlog|monolog|filter-list|couchbase|splunk-hec|azure-loganalytics|amplitude|cloud-feeds|aerospike-cluster)$'
